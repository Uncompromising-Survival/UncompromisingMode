...
local Um_Shadow_AbigailBrain = Class(Brain, function(self, inst)
...
function Um_Shadow_AbigailBrain:OnStart()
    local root = PriorityNode(
    {
        ...
        SequenceNode{
            ...
            --ActionNode(function() self.inst.sg:GoToState("dissipate") end), -- we can't just use ghostbrain scrimbles, it causes shabigail to randomly dissipate
        }
    }, 1)
