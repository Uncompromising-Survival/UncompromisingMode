        ...
        for i = 1, 50 do
            inst:DoTaskInTime((i - 1) / 50, function(inst)
                                    ...
                                    for iv = 1, 50 do
                                        inst:DoTaskInTime((iv - 1) / 50, function(inst)
                                            if v ~= nil and v.Transform:GetWorldPosition() and target ~= nil and tx ~= nil then
                                                ...
                                                local vdebuffmultiplier = inst:HasTag("wixie_shove_3") and 1.15 or inst:HasTag("wixie_shove_2") and 1.1
                                                    or inst:HasTag("wixie_shove_1") and 1.05 or 1
                ...
                if i >= 50 then
                    ...
                    if target.components.locomotor and applyslow then
                        --print("REMOVE SPEED")
