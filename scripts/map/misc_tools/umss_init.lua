...
AddTaskSetPreInitAny(function(tasksetdata)
	...
	elseif tasksetdata.name == GLOBAL.STRINGS.UI.CUSTOMIZATIONSCREEN.TASKSETNAMES.CAVE_DEFAULT then
		local Layouts = GLOBAL.require("map/layouts").Layouts
		local StaticLayout = GLOBAL.require("map/static_layout")
		Layouts["umss_biometable"] = StaticLayout.Get("map/static_layouts/umss_biometable")	
		tasksetdata.set_pieces["umss_biometable"] = {
		...
		tasks = {
			"MudWorld", "MudCave", "MudLights", "MudPit", "BigBatCave", "RockyLand", "RedForest", "GreenForest", "BlueForest", "SpillagmiteCaverns"},
		}	
	end
end)
