...
AddTask("MagmaSacred", { -- Dead End
    ...
    keys_given = { KEYS.MAGMA_CAVES_ENTRANCE, KEYS.MAGMA_CAVES, KEYS.TIER3, KEYS.ACTIVE_LAVA_ZONE },
    level_set_piece_blocker = true,
...
AddTask("MagmaActiveZone", {
    locks = { LOCKS.ACTIVE_LAVA_ZONE },
    keys_given = {},
    level_set_piece_blocker = true,
    entranceroom = "MagmaActive",
    room_tags = { "UM_ActiveLavaZone", "magmacaves", "nohasslers" },
    room_choices = {
        ["MagmaActive"] = 4
    },
    background_room = "MagmaActive",
    room_bg = WORLD_TILES.UM_MAGMA,
    colour = { r = .1, g = .1, b = .1, a = 1 },
})
...
AddTaskSetPreInitAny(function(tasksetdata)
    ...
    table.insert(tasksetdata.tasks, "MagmaActiveZone")
