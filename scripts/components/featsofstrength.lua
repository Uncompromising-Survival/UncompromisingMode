...
function FeatsOfStrength:MightyWork(action, target, tool, numworks)
    local basecost = self.inst.components.skilltreeupdater:IsActivated("wolfgang_critwork_expert") and TUNING.SKILLS.WOLFGANG_MIGHTY_WORK_COST_EXPERT
        or self.inst.components.skilltreeupdater:IsActivated("wolfgang_critwork_4") and TUNING.SKILLS.WOLFGANG_MIGHTY_WORK_COST_4
        or self.inst.components.skilltreeupdater:IsActivated("wolfgang_critwork_3") and TUNING.SKILLS.WOLFGANG_MIGHTY_WORK_COST_3
        or self.inst.components.skilltreeupdater:IsActivated("wolfgang_critwork_2") and TUNING.SKILLS.WOLFGANG_MIGHTY_WORK_COST_2
        or self.inst.components.skilltreeupdater:IsActivated("wolfgang_critwork_1") and TUNING.SKILLS.WOLFGANG_MIGHTY_WORK_COST_1
        or TUNING.SKILLS.WOLFGANG_MIGHTY_WORK_COST
    ...
    if canAfford then
        ...
        self:HandleCost(cost, hungerCost)
        if tool.components.finiteuses and tool.components.finiteuses.consumption[action] then
...
function FeatsOfStrength:MightyLeap(act)
    ...
    local cost = leapexpert and TUNING.FEAT_OF_STRENGTH_MIGHTY_LEAP_EXPERT_COST
        or act.doer.components.skilltreeupdater:IsActivated("wolfgang_mighty_legs_4") and TUNING.FEAT_OF_STRENGTH_MIGHTY_LEAP_4_COST
        or act.doer.components.skilltreeupdater:IsActivated("wolfgang_mighty_legs_3") and TUNING.FEAT_OF_STRENGTH_MIGHTY_LEAP_3_COST
        or act.doer.components.skilltreeupdater:IsActivated("wolfgang_mighty_legs_2") and TUNING.FEAT_OF_STRENGTH_MIGHTY_LEAP_2_COST
        or act.doer.components.skilltreeupdater:IsActivated("wolfgang_mighty_legs") and TUNING.FEAT_OF_STRENGTH_MIGHTY_LEAP_1_COST
        or TUNING.FEAT_OF_STRENGTH_MIGHTY_LEAP_COST
