...
local Um_MiasmaManager = Class(function(self, inst)
    local _world = TheWorld
    assert(_world.ismastersim, "Component Um_MiasmaManager should not exist on the client.")
    ...
    function self:CreateMiasmaAtTile(tx, ty)
        ...
        local x, y, z = _map:GetTileCenterPoint(mtx, mty)
        local ent = SpawnPrefab("um_shadow_miasma_cloud")
