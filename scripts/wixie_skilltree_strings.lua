STRINGS.SKILLTREE.WIXIE = {
	...
	WIXIE_TAUNT_2_DESC = "Reduce speed increase by speed bonus by 5%",
	WIXIE_TAUNT_3_TITLE = "Taunt Bonus II",
	WIXIE_TAUNT_3_DESC = "Reduce speed increase by speed bonus by 10%",
	WIXIE_TAUNT_4_TITLE = "Taunt Bonus III",
	WIXIE_TAUNT_4_DESC = "Reduce speed increase by speed bonus by 15%",
