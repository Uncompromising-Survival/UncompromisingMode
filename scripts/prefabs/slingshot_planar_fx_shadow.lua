local function MakePlanarShadowFx(name, customassets, customprefabs, common_postinit, master_postinit)
    local assets =
    {
...
local COLOUR_ENVELOPE_NAME_SMOKE = "torch_shadow_colourenvelope_smoke-ligma"
local SCALE_ENVELOPE_NAME_SMOKE = "torch_shadow_scaleenvelope_smoke-ligma"
local COLOUR_ENVELOPE_NAME = "torch_shadow_colourenvelope-ligma"
local SCALE_ENVELOPE_NAME = "torch_shadow_scaleenvelope-ligma"
local COLOUR_ENVELOPE_NAME_HAND = "torch_shadow_colourenvelope_hand-ligma"
local SCALE_ENVELOPE_NAME_HAND = "torch_shadow_scaleenvelope_hand-ligma"
...
return MakePlanarShadowFx("slingshot_planar_fx_shadow", assets, nil, common_postinit, master_postinit)