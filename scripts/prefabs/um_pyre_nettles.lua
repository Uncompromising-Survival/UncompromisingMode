...
local function pyrenettle_bumped(inst)
	...
	local nextvictim = FindClosestEntity(inst, bumpradius, true, nil, {  "PyreToxinImmune", "plantkin", "flying", "INLIMBO", "invisible", "notarget", "noattack", "playerghost" })
...
local function SmallPyreNettleGrowthTimerReset(inst)
	...
	local timer_duration = (math.random(1, TUNING.TOTAL_DAY_TIME) + TUNING.TOTAL_DAY_TIME)
