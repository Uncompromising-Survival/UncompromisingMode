...
SetSharedLootTable( "spider_crabbit_den",
{
    {"rocks",  1.00},
    {"rocks",  1.00},
    {"rocks",  1.00},
...
local function basefn(build, loot_table_name, child_name)
    ...
    inst.components.childspawner.childname = "spider_crabbit"
...
local function fn()
    local inst = basefn("lobster_den_build", "spider_crabbit_den", "spider_crabbit")

    return inst
end

return Prefab("spider_crabbit_den", fn, assets, prefabs)
