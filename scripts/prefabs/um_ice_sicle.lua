...
local function ScytheFn()
    ...
    inst.AnimState:SetBuild("um_ice_sicle")
    ...
    inst.fx = SpawnPrefab("um_ice_sicle_fx")
...
local function FollowSymbolFxFn()
    ...
    inst.AnimState:SetBank("um_ice_sicle")
    inst.AnimState:SetBuild("um_ice_sicle")
    inst.AnimState:PlayAnimation("swap_loop_3", true) --frame 3 is used for floating

    inst:AddComponent("highlightchild")

    inst.equiptoggle = net_bool(inst.GUID, "um_ice_sicle_fx.equiptoggle", "equiptoggledirty")
