local SHADER = resolvefilepath("shaders/anim_waterfall_um_floodwater.ksh")
local SHADER_CORNER = resolvefilepath("shaders/anim_waterfall_um_floodwater_corner.ksh")

local BUILDBANK = "waterfall_um_floodwater"
local BUILDBANK_CORNER = "waterfall_um_floodwater_corner"
...
local assets =
{
    Asset("ANIM", "anim/waterfall_um_floodwater.zip"),
    Asset("ANIM", "anim/waterfall_um_floodwater_corner.zip"),
    Asset("SHADER", "shaders/anim_waterfall_um_floodwater.ksh"),
    Asset("SHADER", "shaders/anim_waterfall_um_floodwater_corner.ksh"),
}
...
return Prefab("waterfall_um_floodwater", fn, assets)
