...
local function mosquito()
    ...
    inst.AnimState:SetBuild("smogquito_build")
    ...
    inst.components.combat:SetAttackPeriod(TUNING.MOSQUITO_ATTACK_PERIOD - 1)
...
return Prefab("smogquito", mosquito, assets, prefabs)
