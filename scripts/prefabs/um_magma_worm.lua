...
local function controller_fn()
    ...
    inst:AddTag("groundpound_immune")
    inst:AddTag("electricdamageimmune")
    inst:AddTag("um_magma_worm_controller")
...
return Prefab("um_magma_worm_controller", controller_fn, nil, controller_prefabs),
    Prefab("um_magma_worm_centipede_head", headfn, assets, head_prefabs),
    Prefab("um_magma_worm_centipede_body", torsofn, assets, torso_prefabs)
