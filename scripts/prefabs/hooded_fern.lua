...
local function onpickedfn(inst, picker)
	...
	if picker and picker.components.combat and not picker:HasTag("aphid") and not (picker.components.inventory and (picker.components.inventory:EquipHasTag("bramble_resistant") or picker.components.inventory:EquipHasTag("lazy_forager"))) and not picker:HasTag("shadowminion") and not picker:HasTag("channelingpicker") then
