...
return Prefab("shadow_wixie", fn, assets),
    Prefab("shadow_wixie_helper", helperfn, assets),
    Prefab("shadow_wixie_cloneball", ballfn, assets),
    Prefab("wixie_shadow_clone", shadowclone_fn, assets),
    Prefab("wixie_shadow_ring", ringfn, assets),
    Prefab("wixie_shadow_shield", shieldfn, assets),
    Prefab("wixie_shadow_shot", shadowshot_fn, assets)
