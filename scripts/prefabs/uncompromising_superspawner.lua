...
local spawner_data = {
    ...
    {name = "ancientwalrus", table = umss_tables.ancientwalrus, rotate = true, tile_centered = true, spawninwater_prefab = false, spawninwater_tile = false},
    ...
    {name = "sussy", table = umss_tables.sussy, rotate = true, tile_centered = true, spawninwater_prefab = false, spawninwater_tile = false},
    {name = "badfarmer", table = umss_tables.badfarmer, rotate = true, tile_centered = true, spawninwater_prefab = false, spawninwater_tile = false},
    ...
    {name = "walterifgood", table = umss_tables.walterifgood, rotate = true, tile_centered = true, spawninwater_prefab = false, spawninwater_tile = false},
