...
local function OnAttached(inst, target, followsymbol, followoffset, data)
    ...
    local warlybuff = (target:HasTag("warlybuffed") and (target:HasTag("vetcurse") and 1.8 or 2)) or target:HasTag("vetcurse_wormwood") and 0.5 or target:HasTag("vetcurse") and 0.8 or 1
