...
local function ondeploy(inst, pt, deployer)
    ...
    launchitem(SpawnPrefab("alterguardianhatshard"), math.random() * 360)
...
return Prefab("um_boatbottle", fn, assets), MakePlacer("um_boatbottle_placer", "boat_01", "boat_test", "idle_full", true, false, false, nil, nil, nil, ControllerPlacer_Boat_SpotFinder, 6)
