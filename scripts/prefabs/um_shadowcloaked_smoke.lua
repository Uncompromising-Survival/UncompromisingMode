...
local function IntColour(r, g, b, a)
    return { r / 255, g / 255, b / 255, 130 / 255 }
end
...
local function InitParticles(inst)
    ...
    local smoke_particles_per_tick = (smoke_desired_pps * tick_time) / 2
    local smoke_num_particles_to_emit = -5 --start delay

    local hand_desired_pps = .3
    local hand_particles_per_tick = (hand_desired_pps * tick_time) / 2
...
return Prefab("um_shadowcloaked_smoke", fn, assets)