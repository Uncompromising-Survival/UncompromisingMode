...
if TUNING.DSTU.WAXWELL then
    AddCharacterRecipe("um_maxwell_armor_sanity", {Ingredient("nightmarefuel", 3), Ingredient("waxwelljournal", 0)}, TECH.LOST, {builder_tag = "shadowmagic", product = "armor_sanity", image = "armor_sanity.tex", description = "pact_armor_sanity", actionstr = "UM_WAXWELL_SUMMON", sg_state = "usewaxwelljournal_pre"}, {"ARMOUR", "MAGIC"})
    ChangeSortKey("um_maxwell_armor_sanity", "tophat_magician", "CHARACTER", true)
    ChangeSortKey("um_maxwell_armor_sanity", "armor_sanity", "ARMOUR", true)
    ChangeSortKey("um_maxwell_armor_sanity", "armor_sanity", "MAGIC", true)
    AddCharacterRecipe("um_maxwell_nightsword", {Ingredient("nightmarefuel", 3), Ingredient("waxwelljournal", 0)}, TECH.LOST, {builder_tag = "shadowmagic", product = "nightsword", image = "nightsword.tex", description = "pact_sword_sanity", actionstr = "UM_WAXWELL_SUMMON", sg_state = "usewaxwelljournal_pre"}, {"WEAPONS", "MAGIC"})
    ...
    ChangeSortKey("um_maxwell_nightsword", "nightsword", "MAGIC", true)
end
