...
AddRecipe2("ancient_amulet_red", { Ingredient("thulecite", 2), Ingredient("nightmarefuel", 3), Ingredient("redgem", 2) }, TECH.ANCIENT_FOUR, { nounlock = true, no_builder_skill="wathom_allegiance_neutral", forward_ingredients={"wathom_ancient_amulet_red"} }, { "CRAFTING_STATION" })
ChangeSortKey("ancient_amulet_red", "orangeamulet", "CRAFTING_STATION", false)
...
AddRecipe2("wathom_thulecite", { Ingredient("thulecite_pieces", 6) }, TECH.ANCIENT_TWO, { builder_skill = "wathom_allegiance_neutral", product = "thulecite", description = "thulecite", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_wall_ruins_item", { Ingredient("thulecite", 1) }, TECH.ANCIENT_TWO, { builder_skill = "wathom_allegiance_neutral", product = "wall_ruins_item", numtogive = 6, description = "wall_ruins_item", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_nightmare_timepiece", { Ingredient("thulecite", 2), Ingredient("nightmarefuel", 2) }, TECH.ANCIENT_TWO, { builder_skill = "wathom_allegiance_neutral", product = "nightmare_timepiece", description = "nightmare_timepiece", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_orangeamulet", { Ingredient("thulecite", 2), Ingredient("nightmarefuel", 3), Ingredient("orangegem", 1) }, TECH.ANCIENT_FOUR, { builder_skill = "wathom_allegiance_neutral", product = "orangeamulet", description = "orangeamulet", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_yellowamulet", { Ingredient("thulecite", 2), Ingredient("nightmarefuel", 3), Ingredient("yellowgem", 1) }, TECH.ANCIENT_TWO, { builder_skill = "wathom_allegiance_neutral", product = "yellowamulet", description = "yellowamulet", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_greenamulet", { Ingredient("thulecite", 2), Ingredient("nightmarefuel", 3), Ingredient("greengem", 1) }, TECH.ANCIENT_TWO, { builder_skill = "wathom_allegiance_neutral", product = "greenamulet", description = "greenamulet", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_orangestaff", { Ingredient("nightmarefuel", 2), Ingredient("cane", 1), Ingredient("orangegem", 2) }, TECH.ANCIENT_FOUR, { builder_skill = "wathom_allegiance_neutral", product = "orangestaff", description = "orangestaff", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_yellowstaff", { Ingredient("nightmarefuel", 4), Ingredient("livinglog", 2), Ingredient("yellowgem", 2) }, TECH.ANCIENT_TWO, { builder_skill = "wathom_allegiance_neutral", product = "yellowstaff", description = "yellowstaff", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_greenstaff", { Ingredient("nightmarefuel", 4), Ingredient("livinglog", 2), Ingredient("greengem", 2) }, TECH.ANCIENT_TWO, { builder_skill = "wathom_allegiance_neutral", product = "greenstaff", description = "greenstaff", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_multitool_axe_pickaxe", { Ingredient("goldenaxe", 1), Ingredient("goldenpickaxe", 1), Ingredient("thulecite", 2) }, TECH.ANCIENT_FOUR, { builder_skill = "wathom_allegiance_neutral", product = "multitool_axe_pickaxe", description = "multitool_axe_pickaxe", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_nutrientsgoggleshat", { Ingredient("plantregistryhat", 1), Ingredient("thulecite_pieces", 4), Ingredient("purplegem", 1) }, TECH.ANCIENT_TWO, { builder_skill = "wathom_allegiance_neutral", product = "nutrientsgoggleshat", description = "nutrientsgoggleshat", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_ruinshat", { Ingredient("thulecite", 4), Ingredient("nightmarefuel", 4) }, TECH.ANCIENT_FOUR, { builder_skill = "wathom_allegiance_neutral", product = "ruinshat", description = "ruinshat", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
...
AddRecipe2("wathom_ruins_bat", { Ingredient("livinglog", 3), Ingredient("thulecite", 4), Ingredient("nightmarefuel", 4) }, TECH.ANCIENT_FOUR, { builder_skill = "wathom_allegiance_neutral", product = "ruins_bat", description = "ruins_bat", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_eyeturret_item", { Ingredient("deerclops_eyeball", 1), Ingredient("minotaurhorn", 1), Ingredient("thulecite", 5) }, TECH.ANCIENT_FOUR, { builder_skill = "wathom_allegiance_neutral", product = "eyeturret_item", description = "eyeturret_item", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_shadow_forge_kit", { Ingredient("nightmarefuel", 5), Ingredient("dreadstone", 2), Ingredient("horrorfuel", 1) }, TECH.ANCIENT_FOUR, { builder_skill = "wathom_allegiance_neutral", product = "shadow_forge_kit", description = "shadow_forge_kit", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_blueprint_craftingset_ruins_builder", { Ingredient("papyrus", 3) }, TECH.ANCIENT_TWO, { builder_skill = "wathom_allegiance_neutral", product = "blueprint_craftingset_ruins_builder", description = "blueprint_craftingset_ruins_builder", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_blueprint_craftingset_ruinsglow_builder", { Ingredient("papyrus", 3) }, TECH.ANCIENT_TWO, { builder_skill = "wathom_allegiance_neutral", product = "blueprint_craftingset_ruinsglow_builder", description = "blueprint_craftingset_ruinsglow_builder", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
AddRecipe2("wathom_ancient_amulet_red", { Ingredient("thulecite", 2), Ingredient("nightmarefuel", 3), Ingredient("redgem", 2) }, TECH.ANCIENT_FOUR, { builder_skill = "wathom_allegiance_neutral", product = "ancient_amulet_red", description = "ancient_amulet_red", no_deconstruction = true }, { "CRAFTING_STATION", "CHARACTER" })
ChangeSortKey("wathom_ancient_amulet_red", "wathom_orangeamulet", "CRAFTING_STATION", false)
ChangeSortKey("wathom_ancient_amulet_red", "wathom_orangeamulet", "CHARACTER", false)
AddRecipe2("wathom_um_magnifier", {Ingredient("um_gemologypurplegem2", 1), Ingredient("fossil_piece", 1), Ingredient("thulecite", 1)}, TECH.ANCIENT_THREE, { builder_skill = "wathom_allegiance_neutral", product = "um_magnifier", description = "um_magnifier", no_deconstruction = true}, {"CRAFTING_STATION", "CHARACTER", "TOOLS"})
