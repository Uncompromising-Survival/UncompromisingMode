...
AddRecipe2("um_feather_totem", {Ingredient("um_moss", 3),  Ingredient("livinglog", 1), Ingredient(GLOBAL.CHARACTER_INGREDIENT.HEALTH, 15)}, TECH.MAGIC_TWO, {image="screecher_trinket.tex"}, {"RESTORATION", "MAGIC"})
ChangeSortKey("um_feather_totem", "lifeinjector", "RESTORATION", false)
ChangeSortKey("um_feather_totem", "ressurectionstatue", "MAGIC", false)