...
STRINGS.ACTIONS.USESPELLBOOK.UM_ANTLIONSTAFF = "Change Spell"
...
STRINGS.UI.CRAFTING.UM_NEEDSORIGINALRECIPE = "Craft the original to unlock this recipe."
...
if GLOBAL.KnownModIndex:IsModEnabled("workshop-2010472942") then
    ...
    STRINGS.CHARACTER_DESCRIPTIONS.woose = STRINGS.CHARACTER_DESCRIPTIONS.woose .. "\n󰀕Walks unimpeded on flooded surfaces."
end
...
STRINGS.UM_DESCRIPTOR = {
    ...
    GEM_ENCHANTABLE = {
        ...
        BLUE2 = {
            ...
            "Has freshness instead of durability. Can be fully preserved in an ice box.\nIf the item is already perishable, it now has its freshness extended and can be fully preserved.",
            "Has freshness instead of durability. Can be fully preserved in an ice box.\nIf the item is already perishable, it now has its freshness extended and can be fully preserved.",
        },
        RED1 = {
            "Killing enemies restores health and sanity.",
        ...
        PURPLE1 = {
            "When the user is hit, reduces incoming damage for a short duration.",
            "When the user is hit, reduces incoming damage for a short duration.\nIncreases the damage of weaker weapons.",
            "When the user is hit, reduces incoming damage for a short duration.\nGreatly Increases the damage of weaker weapons.",
        },
        PURPLE2 = {
            "This item and another random item will remain in the inventory after death.",
            "This item and 2 random items will remain in the inventory after death.\nDirect sanity loss is reduced.",
            "This item and 3 random items will remain in the inventory after death.\nDirect sanity loss is greatly reduced.",
        },
        YELLOW1 = {
            "Has small amount of sanity regeneration.",
            "Has small amount of sanity regeneration.\nIncreases the effectiveness of speed boosts.",
            "Has small amount of sanity regeneration.\nGreatly increases the effectiveness of speed boosts.",
        },
        YELLOW2 = {
            "Deals additional electric damage, more for already electric weapons.",
            "Deals additional electric damage, more for already electric weapons.\nAttacks arc between enemies.",
            "Deals additional electric damage, more for already electric weapons.\nAttacks arc between enemies.",
        },
        GREEN1 = {
