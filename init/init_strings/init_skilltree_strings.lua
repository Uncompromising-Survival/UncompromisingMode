...
STRINGS.SKILLTREE.WATHOM = {
    ...
    BITE_1_TITLE = "Bite",
    BITE_1_DESC = "Your unarmed strikes are replaced with a viscious bite, replenishing a small amount of health when used as the killing blow. Become able to sense when creatures are badly hurt",
    BITE_2_TITLE = "Feast",
    BITE_2_DESC = "Slaying a creature with your bite will automatically consume any meat that it would've dropped to the ground, replenishing 50% more stats than usual. Wathom ignores poisoned or high-value foods.",
    ...
    WATHOM_ALLEGIANCE_LOCK_1A = "Temporarily Disabled.",
    ...
    WATHOM_BITE_LOCK = "Unlock Feast and Enhanced Echo",
