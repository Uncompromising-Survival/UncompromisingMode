...
STRINGS.SKILLTREE.WATHOM = {
    ...
    BITE_1_TITLE = "Bite",
    BITE_1_DESC = "Your unarmed strikes are replaced with a viscious bite, replenishing a small amount of health and consuming unimportant edible drops for extra stats when used as the killing blow.",
    BITE_2_TITLE = "Devour",
    BITE_2_DESC = "You are now able to finish off low health enemies in one fatal bite. Further increases the stats from foods consumed from bite kills.",
    --Prowling Hunter: While below 50 Adrenaline, you can come ½ the distance closer to enemies without them noticing you. Deal increased damage to enemies that haven't noticed you.
    ...
    ECHOLOCATION_1_TITLE = "Enhanced Echo",
    ...
    ECHOLOCATION_2_DESC = "When your echolocation ability is active, you can see the range that creatures will hear and notice your presence.", --Receive warnings of incoming Hound, Worm, and giant attacks far sooner than usual, up to a day in advance.
    WATHOM_ALLEGIANCE_LOCK_1A = "Unlock Shadow Form.",
    ALLEGIANCE_SHADOW_LOCK_DESC = "Find and consume the Shadow Atrium.",
    ALLEGIANCE_ANCIENT_LOCK_DESC = "Uncover forgotten knowledge within the Archives.",
    WATHOM_ALLEGIANCE_LOCK_1B = "Unlock Artifact Affinity.",
    WATHOM_BITE_LOCK = "Unlock Feast and Echo",
    ...
    WATHOM_ALLEGIANCE_SHADOW_TITLE = "Abyssal Terror I",
    ...
    ANCIENT_TERROR_2_TITLE = "Abyssal Terror II",
    ANCIENT_TERROR_2_DESC = "Deal +30% damage to Lunar creatures. [TEMP]",
    ANCIENT_TERROR_3_TITLE = "Abyssal Terror III",
...
STRINGS.SKILLTREE.WATHGRITHR.WATHGRITHR_ALLEGIANCE_SHADOW_DESC = "Combat sustain and damage resistance are greatly increased.\n Shadow item sanity drain is halved.\n Battle Calls are no longer available."
STRINGS.SKILLTREE.WATHGRITHR.WATHGRITHR_ALLEGIANCE_LUNAR_DESC = "Battle Calls have additional effects.\n Combat sustain is removed."
--------------------------------------------------------------------------
-- WOLFGANG
--------------------------------------------------------------------------
