...
--	[ 		Webber Descriptions		]	--
	...
	DESCRIBE.OCUPUS_TENTACLE = "We'd shake your hand but it's, well..."
    ...
    DESCRIBE.UM_SALTSALVE  = "It hurts, but it's good for us."
	...
	DESCRIBE.STEERINGWHEEL_COPPER = "We might get sea sick."
