...
--	[ 		Wanda Descriptions		]   --
	...
	DESCRIBE.OCUPUS_TENTACLE_COOKED = "You are best as sashimi."
    ...
    DESCRIBE.SLUDGE = "Thicker than molasses"
	DESCRIBE.SLUDGE_OIL = "Could always use more oil."
	...
	DESCRIBE.BOAT_BUMPER_SLUDGE = "I doubt it will last long."
	DESCRIBE.BOAT_BUMBER_SLUDGE_KIT = "Let's find a good place to put it."
