...
env.AddPlayerPostInit(function(inst)
	...
	local function OnSave(inst, data, ...)
		...
		if inst.wilson_vetcurse then
			data.wilson_vetcurse = inst.wilson_vetcurse
		end
		...
		if inst.wolfgang_vetcurse ~= nil then
			data.wolfgang_vetcurse = inst.wolfgang_vetcurse
		end
			
		if inst.wanda_vetcurse ~= nil then
			data.wanda_vetcurse = inst.wanda_vetcurse
		end
			
		if inst.wathgrithr_vetcurse then
			data.wathgrithr_vetcurse = inst.wathgrithr_vetcurse
		end

		if inst.wes_vetcurse then
			data.wes_vetcurse = inst.wes_vetcurse
		end

		if inst.wendy_vetcurse then
			data.wendy_vetcurse = inst.wendy_vetcurse
		end
			
		if inst.um_deathcount then
			data.um_deathcount = inst.um_deathcount
		end
