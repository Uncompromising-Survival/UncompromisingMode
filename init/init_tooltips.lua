...
STRINGS.PINETREE_TOOLTIP = {
    ...
    BEDROLL_STRAW = "- A Pinetree Pioneer knows how to conserve energy when relaxing!",
    BEDROLL_FURRY = "- A Pinetree Pioneer knows how to conserve energy when relaxing!",
    TENT = "- A Pinetree Pioneer knows how to conserve energy when relaxing!",
    SIESTAHUT = "- A Pinetree Pioneer knows how to conserve energy when relaxing!",
    PORTABLETENT_ITEM = "- A Pinetree Pioneer knows how to conserve energy when relaxing!",
