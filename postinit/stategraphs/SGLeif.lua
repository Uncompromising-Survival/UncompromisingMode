    ...
    local states = {
        State{
            ...
            timeline =
            {
                ...
                TimeEvent(36 * FRAMES, function(inst) inst.sg:RemoveStateTag("busy") end),
            },
        ...
        State{
            ...
            timeline =
            {
                ...
                TimeEvent(50 * FRAMES, function(inst) inst.sg:RemoveStateTag("busy") end),
            },
