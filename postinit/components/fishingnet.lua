	...
	function self:BeginOpening()
		...
		if self.inst:HasTag("uncompromising_fishingnetvisualizer") then
			...
			for k, v in pairs(fishies) do
				...
				local fish = fishdef ~= nil and (SpawnPrefab(fishdef.."_inv") ~= nil and SpawnPrefab(fishdef.."_inv") 
					or SpawnPrefab(fishdef.."_land") ~= nil and SpawnPrefab(fishdef.."_land") or nil)
					or nil
