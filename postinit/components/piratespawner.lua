...
env.AddComponentPostInit("piratespawner", function(self)
    ...
    --local lootlist = UMUpvalueHacker.TryGetUpvalue(self.GetCurrentStash, "generateloot", "lootlist")
    local _generateloot = UMUpvalueHacker.TryGetUpvalue(self.GetCurrentStash, "generateloot")
    if _generateloot then
