...
configuration_options = {
    ...
    { name = "flingo_setting", label = "Flingomatic Nerf",
                                                                       hover =
    ...
    { name = "fireloot",       label = "Burning Loot Drop Rework",
        ...
        "Loot no longer gets destroyed when a mob is burnt to death. Mobs will explode on death, dealing damage and lighting things on fire, based on loot dropped.",
            ...
            { description = "Explosion On", data = 3 } },                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 default = 3 },
    ...
    { name = "wathom_ampvulnerability", label = "Wathom: Amped Vulnerability",
                                                                                     hover =
        "Wathom takes more damage when amped.",
                                                                                                                                                                     options = {
            { description = "5x (Default)", data = 5 }, { description = "4x", data = 4 }, { description = "3x", data = 3 },
            { description = "2x", data = 2 } },                                                                                                                                                                                                                                                                                                                                                                                               default = 5 },
    { name = "wathom_armordamage",      label = "Wathom: Armor Damage Priority",
        ...
        "Wathom can take increased damage, choose if armor damage is ignored.",
                                                                                                                                                                     options = {
            { description = "Include Armor", data = true,
                hover = "Wathom multiplies incoming damage by the current damage multiplier" },
            { description = "Don't include armor", data = false,
                hover = "Wathom multiplies resulting damage by the current damage multiplier." } },                                                                                                                                                                                                                                                                                                                                           default = true },
