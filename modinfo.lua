...
description = [[
󰀔 [ Version 1.1.6: "Under the Weather Pt.1" ]
...
version = "Under the Weather Pt.1 v1.1.6"
...
configuration_options = {
    ...
    {name = "bossresistance", label = "Dynamic Boss Resistance", hover = "Some bosses have increasing resistance against multiple players", options = {{description = "Dynamic", hover = "Bosses change their resistance based on hits taken.", data = "Dynamic"}, {description = "Static", hover = "Bosses change their resistance based on nearby players.", data = "Static"}, {description = "Disabled", data = false}}, default = "dynamic"},
    ...
    BinaryConfig("warly_butcher", "Experimental Warly's Butchering", "Warly is a certified butcher, he can sometimes get more resources from his kills.", true),
    ...
    -- true),
    BinaryConfig("horticulture, expanded", "Wickerbottom: Horticulture, Exp.", "\"Horticulture, Expanded\" now grows 20 plants, instead of 15.", true),
    BinaryConfig("lux aeterna", "Wickerbottom: Lux and Redux", "\"Lux Aeterna\" and \"Lux Aeterna Redux\" now both last longer.", true),
